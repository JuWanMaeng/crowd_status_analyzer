...
class FERDataset(data.Dataset):   # 흑백 감정 이미지 dataset (48,48)
    ...
    def __init__(self,phase):
        ...
        self.phase=phase
        with open(f'data/emotion/{phase}.json', 'r') as f:
...
class ExpDataset(data.Dataset): # 칼라 이미지 감정 dataset (100,100)
...
class GenderDataset(data.Dataset):  # UTKFace 에서 성별만 따로 뽑음
    ...
    def __init__(self,phase):
        ...
        self.phase=phase
        with open(f'data/UTKFace/single_{phase}.json', 'r') as f:
            self.data=json.load(f)
